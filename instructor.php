...
<head>
    <meta charset="utf-8">
    <title>Teach Mate : Instructor</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        <a href="index.html" class="navbar-brand d-flex align-items-center px-4 px-lg-5">
            <p class="m-0 fw-bold" style="font-size: 25px;"><img src="img/icon.png" alt="" height="50px">Teach<span style="color: #fb873f;">Mate</span></p> 
        </a>
        ...
        <div class="container">
            ...
            <div class="row g-4">
                <div class="col-lg-12 wow fadeInUp" data-wow-delay="0.1s">
                    <h5>Welcome to TeachMate - Where Knowledge Meets Innovation</h5>
        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <h1 class="mb-4" style="color: #fb873f;">Why Choose TeachMate as Your Teaching Hub?</h1>
        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <div class="row gy-2 gx-4 mb-4">
                        <ul style="list-style: none;">
                            <li><i class="fa fa-check"></i> Familiarize yourself with Teach Mate and the diverse range of courses we offer.</li>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form>
                <h5 class="mb-4">Join TeachMate's Global Community
        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-12 wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <p>At TeachMate, we believe that education has the power to transform lives. Join us in creating a world where knowledge knows no bounds, and together, let's inspire, innovate, and educate!</p>
