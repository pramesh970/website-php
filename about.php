...
<head>
    <meta charset="utf-8">
    <title>TeachMate : About Us</title>
        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-12 wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <h1 class="mb-4" style="color: #fb873f;">Welcome to TeachMate</h1>
                    <p class="mb-4">
                        At TeachMate, we believe in accessible, innovative learning experiences that adapt to your
                    ...
                    <p class="mb-4">Welcome to TeachMate, where learning knows no boundaries. Our mission
                        is to empower individuals worldwide through accessible and innovative education. Here's what
                        sets us apart:</p>

                    <h3 class="mb-4">Our Vision</h3>
                    <p class="mb-4">At TeachMate, we envision a world where learning is accessible to everyone,
                    ...
                    <p class="mb-4">We believe in the transformative power of education. TeachMate is
                    ...
                    <p class="mb-4"> TeachMate is more than just courses; it's a vibrant community. We
                    ...
                    <p class=" mt-5 mb-4">Thank you! for being a part of TeachMate. Together, let's embark on a
        ...
        <div class="container py-5">
            <div class="row g-5">
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <i class="fa fa-phone-alt me-3"></i>+977-9812354076</p>
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <p>Stay updated with the latest course offerings and educational resources from TeachMate. Subscribe
                        to our newsletter today!</p>
                    <div class="position-relative w-100">
                        <input class="form-control border-0 rounded-pill w-100 ps-4 pe-5" type="text"
                            placeholder="Your email">
                        <button type="button"
                            class="btn shadow-none position-absolute top-0 end-0 mt-1 me-2 rounded-pill">SignUp</button>
                    </div>
                </div>
            ...
            <div class="copyright">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        &copy; <a class="border-bottom" href="#">Teach Mate</a>, All Right Reserved.
                    </div>
